...
3. **Isolate the problem to Docs** &mdash; make sure that the code in the Docs
...
fits with the scope and aims of Docs. It's up to *you* to make a strong
case to convince the Docs developers of the merits of this feature. Please
...
time working on something that the developers might not want to merge into Docs.
...
1. [Fork](http://help.github.com/fork-a-repo/) Docs, clone your fork,
